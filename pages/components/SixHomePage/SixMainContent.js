...
function SixMainContent({handleSubmit,setHandleSumbit}) {
  ...
  return (
      <div className='min-h-screen w-1/2 lg:w-3/4 p-2 mx-auto '>
    `  <h1 className='text-center text-3xl py-5'>euGJ;tdOoud;yS:zJtH:ohvD:.</h1>
        <form ref={form} onSubmit={sendEmail} className='w-[450px] justify-center flex flex-col mx-auto gap-y-1'>
         ...
         <div className='text-2xl flex justify-center space-x-10'>
           <div>
            <div className='pb-5'>
              <p>u0DR</p>
              <p>o&.ed.&apos;h</p>
              <p className='font-sans text-sm'>pdee@kbcusacn.org</p>
              <p className='font-sans text-sm'>402-601-9414</p>
            </div>
            <div>
              <p>u0DRydmrk.u&X</p>
              <p>o&.rk.zJ0grk{'>'}</p>
              <p className='font-sans text-sm'>pwah@kbcusacn.org</p>
              <p className='font-sans'>402-594-4502</p>
              <p>o&.rk.%SJz</p>
              <p className='font-sans text-sm'>970-405-1856</p>
            </div>
           </div>
           <div>
            <div className='pb-5'>
              <p>u0DRusJ;pX;u&X</p>
              <p>eD{'>'}unDzDpd</p>
              <p className='font-sans text-sm'>kpawsoe@kbcusacn.org</p>
            ...
            <div>
              ...
              <p>o&.rk.&apos;d. &apos;bd&RA</p>
              <p className='font-sans text-sm'>720-216-3173</p>
              <div className='flex items-center pt-5'>
                <p className='font-sans text-sm'>Email provider: </p>
